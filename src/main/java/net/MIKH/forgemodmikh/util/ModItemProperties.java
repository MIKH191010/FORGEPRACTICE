...
public class ModItemProperties {
    public static void addCustomItemProperties(){
        ...
        ItemProperties.register(ModItem.CHISELER.get(), ResourceLocation.fromNamespaceAndPath(ForgeModMIKH.MOD_ID,"used"),
                (pStack, pLevel, pEntity, pSeed) ->
                        pStack.get(ModDataComponentTypes.COORDINATES.get()) != null ? 1f : 0f);
        makeCustomBow(ModItem.PHOENIX_BOW.get());
    }
